...
{ 
   ...
   { 
      ...
      { 
         //Query the DB 
         $query = mysqli_query($con,"SELECT * FROM maze WHERE username = '$user'") or die("Can not query the TABLE!"); 
         ...
         { 
            $add = mysqli_query($con,"INSERT INTO maze (id, username, password) VALUES (null, '$user' , '$pass') ") or die("Can't                Insert! "); 
